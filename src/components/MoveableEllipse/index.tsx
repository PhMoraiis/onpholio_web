...
const MoveableEllipse = () => {
  return (
    <motion.svg
      ...
      whileHover={{ cy: 342.782 }} // Define a posição da elipse quando o mouse estiver sobre o SVG
      whileTap={{ cy: 142.782 }} // Define a posição da elipse quando o mouse estiver pressionado sobre o SVG
      transition={{ duration: 0.3, ease: "easeInOut" }} // Define a duração e o tipo de transição
    >
      <defs>
      ...
      <path d="M0 128.19C0 79.4073 39.5461 39.8611 88.3288 39.8611C137.111 39.8611 176.658 79.4073 176.658 128.19V372.373C176.658 421.156 137.111 460.702 88.3288 460.702C39.5461 460.702 0 421.156 0 372.373V128.19Z" fill="url(#paint0_linear_191_37)"/>
      <motion.ellipse cx="88.3288" cy={cy} rx="75.3801" ry="77.5985" fill="url(#paint1_linear_191_37)"/>
      <path d="M237.271 76.4927L319.072 196.595V76.4927H346.156V239H319.345L235.903 119.992V239H208.819V76.4927H237.271Z" fill="url(#paint2_linear_191_37)"/>
...
export default MoveableEllipse;